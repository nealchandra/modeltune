...
-- CreateEnum
CREATE TYPE "TrainingJobStepTypes" AS ENUM ('JOB_STARTED', 'JOB_FAILED', 'JOB_COMPLETED', 'JOB_CANCELLED', 'PREPARING_DATASET', 'TRAINING_STARTED', 'EPOCH_COMPLETED', 'WANDB_RUN_CREATED');
